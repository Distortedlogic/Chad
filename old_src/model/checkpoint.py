...
from old_src import (DEBUG, HOF_SIZE, LIMIT, MAX_TRADE_AMOUNT, MIN_NUM_TRADES,
...
from old_src.rules.constants import PSET, TERMINALS
...
class Checkpoint:
    ...
    chad_kwargs: Dict[str, Any] = field(default_factory=lambda: {"pairs": PAIRS,
                                                                 ...
                                                                 "pset": PSET})
    random_state: tuple[Any, ...] = field(init=False)
