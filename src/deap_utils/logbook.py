...
from src.api.dataframe import display_df
from src.api.time_utils import secondsToText
...
class Logbook:
    ...
    uuid: str
    df: DataFrame = field(default_factory=lambda: DataFrame(columns=["distinct",
                                                                     "num_changed",
                                                                     "min_height",
                                                                     "avg_height",
                                                                     "max_height",
